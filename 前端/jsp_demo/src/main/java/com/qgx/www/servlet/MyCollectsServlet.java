...
import com.qgx.www.service.impl.MyCollectsServiceImpl;
...
@WebServlet(urlPatterns = "/myCollects.s")
public class MyCollectsServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //业务处理
        MyCollectsService myCollectsService=new MyCollectsServiceImpl();
        List<Product> productList=myCollectsService.getMyCollectProduct(Integer.parseInt(pageNo),pageSize,phone);
        int totalCount=myCollectsService.grtCount(phone);
